...
\begin{aligned}
\begin{equation}
\Sigma=\left[\begin{array}{ccc}{\text{Cov}\left[X_{1}, X_{1}\right]} & {\cdots} & {\text{Cov}\left[X_{1}, X_{n}\right]} \\ {\vdots} & {\ddots} & {\vdots} \\ {\text{Cov}\left[X_{n}, X_{1}\right]} & {\cdots} & {\text{Cov}\left[X_{n}, X_{n}\right]}\end{array}\right]\\
